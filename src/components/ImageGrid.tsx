export default function ImageGrid({ images }: { images: string[] }) {
  return (
    <div className="overflow-hidden rounded-md">
      <div className="grid grid-cols-10 gap-2 h-full lg:min-h-[600px]">
        <div className="col-span-10 sm:col-span-5 overflow-hidden">
          <img src={images?.[0] || "/images/placeholder.svg"} alt="" className="hover:opacity-80 duration-300 h-full object-cover" />
        </div>
        <div className="col-span-5 overflow-hidden grid lg:grid-cols-2 gap-2">
          ...
          <div className="grid-cols-2 w-full col-span-2 gap-2 h-full md:grid hidden">
            <img
              src={images?.[3] || "/images/placeholder.svg"}
              alt=""
              className="hover:opacity-80 duration-300 h-full object-cover"
            />
            <img
              src={images?.[4] || "/images/placeholder.svg"}
              alt=""
              className="hover:opacity-80 duration-300 h-full object-cover"
            />
          </div>
