            ...
            <div className="max-w-7xl mx-auto space-y-12 md:space-y-16 animate-fade-in relative">
              ...
              <div className="relative text-center space-y-6 md:space-y-8 px-6 mt-10">
                ...
                <p className="text-base md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  Discover quality PGs, apartments, and hostels tailored for
                  your work or study needs. Your ideal accommodation is just a
                  search away.
                </p>
                    ...
                    <div className="flex flex-wrap gap-2 justify-center items-center">
                      {locations.map((loc) => (
                        <button
                          key={loc._id}
                          onClick={() =>
                            handleLocationClick(loc.title, loc._id)
                          }
